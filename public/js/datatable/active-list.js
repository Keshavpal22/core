(function ($) {
    ...
    $(document).ready(function () {
        ...
        var dTable = $('#active-list').DataTable({
            ...
            ajax: {
                ...
                url: '../bookings/active/list',  // Ensure this URL is correct

                type: "GET",

                data: function (d) {

                    // Add customer_type to the AJAX data

                    var customerType = $('#customer-type').val(); // Assuming you added an id for your dropdown
        ...
        $('#customer-type').on('change', function () {
            ...
            dTable.ajax.reload();  // Reload DataTable with the updated filter
