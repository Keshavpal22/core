(function ($) {
    ...
    $(document).ready(function () {
        var dTable = $('#finance-list').DataTable({
            scrollY: 425,
            scrollX: true,
            paging: true,
            fixedColumns: {
            ...
            ajax: {
                ...
                type: "GET",
                data: function (d) {
                    var finMode = $('#fin-mode-filter').val();
                    d.fin_mode = finMode; // Send the selected fin_mode to the controller
                }
            },
            columns: [
        ...
        // Reload table when fin-mode-filter changes
        $('#fin-mode-filter').on('change', function () {
            dTable.ajax.reload();
        });
    });
