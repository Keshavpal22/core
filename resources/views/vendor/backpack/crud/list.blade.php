...
<style>
    ...
    /* ⭐ Pivot Button Size = same as Reset */
    #togglePivot.btn-sm {
...
document.addEventListener('DOMContentLoaded', function () {
    const columnDefs = [
        { headerName:"", field:"id", width:50, pinned:"left",
          checkboxSelection:true, headerCheckboxSelection:true, sortable:false },
        ...
        { headerName:"Total Marks", field:"total_marks", type:"numericColumn", aggFunc:"sum", enableRowGroup:true, enableValue:true },
        { headerName:"Percentage", field:"percentage", type:"numericColumn", aggFunc:"avg", enableRowGroup:true, enableValue:true },
        { headerName:"Attendance %", field:"attendance_percent", type:"numericColumn", aggFunc:"avg", enableRowGroup:true, enableValue:true },
        { headerName:"Fee Paid", field:"fee_paid", type:"numericColumn", aggFunc:"sum", enableRowGroup:true, enableValue:true },
        { headerName:"Fee Due", field:"fee_due", type:"numericColumn", aggFunc:"sum", enableRowGroup:true, enableValue:true },
